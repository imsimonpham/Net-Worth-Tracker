const categories = {
  expense: [
    ...
    { id: 6, name: 'Electricity', value: 'Electricity' },
  ...
  investment: [
    { id: 0, name: 'Select an option', value: '' },
    { id: 1, name: 'IBKR', value: 'IBKR' },
    { id: 2, name: 'NDAX', value: 'NDAX' },
    { id: 3, name: 'WS-FHSA', value: 'WS-FHSA' },
    { id: 4, name: 'WS-RRSP', value: 'WS-RRSP' },
    { id: 5, name: 'WS-TFSA', value: 'WS-TFSA' }
  ]
};
